...
namespace Enemy
{
    ...
    public class Enemy : MonoBehaviour, IDieable
    {
        ...
        public WarriarAnimation MoveAnimation { get; private set; }
        ...
        public void Initialize(CharacterView character, UpdateServise updateServise)
        {
            MovementController jumpMovementFacade = GetComponent<MovementController>();
            ...
            MoveAnimation = new WarriarAnimation(Movement, _animator, _selfTransform, updateServise);
